...
test.describe('ToDo UI smoke tests', () => {
    ...
    test('add, list, and complete a task @smoke', async ({ page }) => {
        ...
        // Verify completion
        await expect(page.getByTestId('todo-success')).toContainText('Marked "Document API changes" as complete.');
    ...
    test('prevents adding duplicate task titles @smoke', async ({ page }) => {
        ...
        await expect(page.getByTestId('todo-error')).toContainText('A todo with the same title already exists.');
    ...
    test('complete task by ID form @smoke', async ({ page }) => {
        ...
        // Verify success
        await expect(page.getByTestId('todo-success')).toContainText('Marked "Prepare sprint review deck" as complete.');
